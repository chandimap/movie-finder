...
class ActorListItem extends Component {
  render() {
    ...
    return (
      ...
      <Link to={ '/actor/' + id }><img src={ ( profile_path && 'https://image.tmdb.org/t/p/w500/' + profile_path ) || '/movie-finder/images/default.jpg' } alt="" className="img-fluid img-link-img"/></Link>
